export function parameter(key, label, min, max, step, value, help) {
...
export function defaults(effect) {
    return Object.fromEntries(effect.parameters.map(p => [p.key, p.value]));
}
export function normalize(effect, input) {
...
export function frameUniforms(effect, settings, progress, aspect) {
